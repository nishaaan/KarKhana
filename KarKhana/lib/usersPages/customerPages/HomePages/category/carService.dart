...
class CategoryCarService extends StatefulWidget {
  const CategoryCarService({super.key});

  @override
  State<CategoryCarService> createState() => _CategoryCarServiceState();
}

class _CategoryCarServiceState extends State<CategoryCarService> {
      ...
      body: Column(
        children: [
          ...
          Padding(
            ...
            child: FutureBuilder(
                future: category.getCategoryDeals(query: "Car Service Deals"),
